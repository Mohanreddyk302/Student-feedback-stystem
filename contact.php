...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#342b2b">Contact us </font></h3>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Name : Mohan Reddy K </Br>

                    Bangarpet, Kolar, India - 563114 <br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Mobile No.:  </abbr>: (+91) 9632764514</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email id">Email</abbr>: <a href="mailto:name@example.com">mohanreddyk302@gmail.com.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Hours</abbr>: Monday - Sunday: 9:00 AM to 6:00 PM</p>
